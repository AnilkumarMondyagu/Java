...
public class BasicDocumentGrader {
    public static void main(String[] args) {
        try
        {
            ...
            BufferedReader br = new BufferedReader(new FileReader("mod1TestCases.txt"));
            String line;
            PrintWriter out = new PrintWriter("module1.part1.out", "utf-8");
            ...
            br = new BufferedReader(new FileReader("mod1TestCases.txt"));
            out = new PrintWriter("module1.part2.out", "utf-8");
            while ((line = br.readLine()) != null)
            {
                BasicDocument doc = new BasicDocument(line);
